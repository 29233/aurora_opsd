...
# Two-card V100/A100 entry point. Every value remains overridable by the
...
# Match the 8-card reference global batch: 2 GPUs x 4 accumulation = 8.
...
export OUTPUT_DIR="${OUTPUT_DIR:-${ROOT_DIR}/outputs/train/videollama2_2gpu_10f}"
mkdir -p "${OUTPUT_DIR}"
